                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{ url('/public') }}/src/assets/images/faces/2.jpg" alt="">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{ url('/public') }}/src/assets/images/faces/3.jpg" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{ url('/public') }}/src/assets/images/faces/4.jpg" alt="">
                                <div class="flex-grow-1">
                                ...
                                <table id="user_table" class="table dataTable-collapse text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Smith</td>
                                            <td>
                                                <img class="rounded-circle m-0 avatar-sm-table " src="{{ url('/public') }}/src/assets/images/faces/1.jpg" alt="">
                                            </td>
