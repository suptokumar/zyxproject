...
@section("content")
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="{{url('addcoupons')}}" class="btn btn-info">
                        <i class="nav-icon i-Add"></i>
                        <span class="item-name">Create New Coupon</span>
                    </a>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="dropdown dropleft text-right w-50 float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_table1">
                                    <a class="dropdown-item" href="{{url('addcoupons')}}">Create New Coupon</a>
                                ...
                                <table id="user_table" class="table dataTable-collapse text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="unis{{$page->id}}">
                                            ...
                                            <td>{{$page->vendor}}</td>                                            
                                            <td>
                                                <a href="{{url('editcoupons')}}/{{$page->id}}" class="text-success mr-2">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="50" class="text-center text-info">No Coupons Found</td>
                                        </tr>
                                        @endforelse                                        
                                    </tbody>
                                </table>
