...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        @endif
        <form action="{{url('editbankoffers')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="gateway" class="form-control" id="gateway">
                    ...
                    <option value="{{$vendor->id}}" {{ $vendor->id==$coupon->gateway?"selected":"" }}>{{$vendor->vendorName}}</option>  
                    @endforeach
                </select>
            </div>
            <div class="form-group">
