...
@section("content")
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="{{url('create/pages')}}" class="btn btn-info">
                        <i class="nav-icon i-Add"></i>
                        <span class="item-name">Create Custom Pages</span>
                    </a>
                </div>
                <div class="col-md-12">
                    <div class="card o-hidden mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">All Pages</h3>
                            <div class="dropdown dropleft text-right w-50 float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_table1">
                                    <a class="dropdown-item" href="{{url('create/pages')}}">Create Custom Pages</a>
                                ...
                                <table id="user_table" class="table dataTable-collapse text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="unis{{$page->id}}">
                                            ...
                                            <td>{{$page->status}}</td>                                            
                                            <td>
                                                <a href="{{url('edit/pages')}}/{{$page->id}}" class="text-success mr-2">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="50" class="text-center text-info">pages is not available</td>
                                        </tr>
                                        @endforelse                                        
                                    </tbody>
                                </table>
