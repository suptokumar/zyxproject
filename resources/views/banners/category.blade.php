...
<div class="breadcrumb">
    ...
    <ul>
        ...
        <li>View all banners category</li>
    </ul>
</div>
@endsection
@section("content")
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="{{url('banners/create-category')}}" class="btn btn-info">
                        <i class="nav-icon i-Add"></i>
                        <span class="item-name">Create Banner Category</span>
                    </a>
                </div>
                <div class="col-md-12">
                    <div class="card o-hidden mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">All Banner Category</h3>
                                ...
                                <table id="user_table" class="table dataTable-collapse text-center">
                                    ...
                                    <tbody>
                                        @php
                                            $i= 1;
                                        @endphp
                                        @forelse ($allbannerCategories as $Category)
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="50" class="text-center text-info">Banner Category not available</td>
                                        </tr>
                                        @endforelse                                        
                                    </tbody>
                                </table>
