                                ...
                                <table id="user_table" class="table dataTable-collapse text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="unis{{$faqs->id}}">
                                            ...
                                            <td>{{$faqs->answer}}</td>                                            
                                            <td>
                                                <a href="{{url('edit/faqs')}}/{{$faqs->id}}" class="text-success mr-2">
                                                    <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                                                </a>
                                                <a href="javascript:void(0)" class="delete_faqs" data-toggle="modal" data-target="#dnoeod1d11" onclick="delete_delta_step({{$faqs->id}},'unis{{$faqs->id}}');" id="faqs_delete"  class="text-danger mr-2">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="50" class="text-center text-info">faqs is not aviable</td>
                                        </tr>
                                        @endforelse                                        
                                    </tbody>
                                </table>
