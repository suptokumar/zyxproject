...
<head>
    ...
    <link rel="stylesheet" href="{{asset("/public/plugin/selectize.css")}}">
        ...
        <!-- Notificaiton End -->
            ...
            <div class="dropdown">
                <div class="user col align-self-end">
                    <img src="{{url('/public/src/assets')}}/images/faces/1.jpg" id="userDropdown" alt=""
...
<script src="{{ url('/public') }}/src/assets/js/es5/echart.options.min.js"></script>
<script src="{{ url('/public') }}/src/assets/js/es5/dashboard.v2.script.min.js"></script>
