                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-4">
                            ...
                            <h1 class="mb-3 text-18">Recover Account</h1>
...
@csrf
                                ...
                                <button class="btn btn-rounded btn-primary btn-block mt-2">Get Recovery Email</button>

                            </form>

                            <div class="mt-3 text-center">
                                <a href="{{ url('/login') }}" class="text-muted"><u>Login Now</u></a>
                            </div>
                        </div>
                    </div>
