<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item">
                <a class="nav-item-hold" href="{{ url('subadmin') }}">
                    <i class="nav-icon i-Shop-2"></i>
                    <span class="nav-text">SubAdmin Management</span>
                </a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item active" data-item="orders">
            ...
            <li class="nav-item" data-item="invoice">
                <a class="nav-item-hold" href="{{ url('invoice') }}">
                    <i class="nav-icon i-Folder-Search"></i>
            ...
            <li class="nav-item" data-item="review_management">
                <a class="nav-item-hold" href="{{ url('review') }}">
                    <i class="nav-icon i-Optimization"></i>
            ...
            <li class="nav-item">
                <a class="nav-item-hold" href="{{ url('sendnotifications') }}">
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="vendor">
            ...
            <li class="nav-item">
                <a href="{{route("vendor.plan")}}">
                    <i class="nav-icon i-Paypal"></i>
                    <span class="item-name">Vendor Plan Change Requests</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="{{url("view/approveproducts")}}">
        ...
        <ul class="childNav" data-parent="orders">
            <li class="nav-item">
                <a href="{{url('view/orders')}}">
                    <i class="nav-icon i-Full-View-Window"></i>
                    <span class="item-name">View All Orders</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url('create/orders')}}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Create New Orders</span>
                </a>
            </li>
        ...
        <ul class="childNav" data-parent="settings">
            <li class="nav-item">
                <a href="{{route("admin.tax.index")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Admin Tax</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/configure_vendor_website")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Configure Vendor Website</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/productunit")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Product Unit</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/paymentgateways")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Payment Gateways</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/vendorstats")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Vendor Stats</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/deliveryradius")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Default Delivery Radius</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/smssettings")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Notifications and SMS Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/email")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Email Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/tawk")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">tawk.to Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/domainSettings")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Domain Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/whatsappsettings")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">WhatsApp Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/mapssettings")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Maps Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/poweredbytext")}}">
                    <i class="nav-icon i-Settings-Window"></i>
                    <span class="item-name">Powered by text</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url("/settings/appsettings")}}">
                    <i class="nav-icon i-Settings-Window"></i>
        ...
        <ul class="childNav" data-parent="driver_management">
            <li class="nav-item">
                <a href="{{route("driverModule.pending")}}">
                    <i class="nav-icon i-Full-View-Window"></i>
            ...
            <li class="nav-item">
                <a href="{{ route("driverModule.create") }}">
                    <i class="nav-icon i-Approved-Window"></i>
                    <span class="item-name">Add Driver</span>
                </a>
            </li>
            {{--                    <li class="nav-item">
                                    <a href="{{ route("driverModule.track") }}">
                                        <i class="nav-icon i-Statistic"></i>
                                        <span class="item-name">Track Drivers</span>
                                    </a>
                                </li>--}}
            <li class="nav-item">
                <a href="{{ route("driverModule.settings") }}">
                    <i class="nav-icon i-Paypal"></i>
                    <span class="item-name">Delivery Settings</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route("driverModule.payouts") }}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Payout Requests</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route("driverModule.deposits") }}">
                    <i class="nav-icon i-Folder-Settings"></i>
                    <span class="item-name">Driver Deposits Requests</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route("driverModule.transaction.list") }}">
                    <i class="nav-icon i-Folder-Settings"></i>
        ...
        <ul class="childNav" data-parent="review_management">
            <li class="nav-item">
                <a href="{{ url('/review/vendor') }}">
                    <i class="nav-icon i-Full-View-Window"></i>
                    <span class="item-name">Vendor Review</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('/review/driver') }}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Driver Review</span>
                </a>
            </li>
        </ul>
        ...
        <ul class="childNav" data-parent="sponsored_vendor_plans">
            <li class="nav-item">
                <a href="{{ url("sponsored_vendor_plans") }}">
                    <i class="nav-icon i-Full-View-Window"></i>
                    <span class="item-name">View Plans</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("sponsored_vendor_plans/create") }}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Add Plan</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("sponsored_vendor_plans/upgraderequests") }}">
                    <i class="nav-icon i-Optimization"></i>
        ...
        <ul class="childNav" data-parent="system">
            <li class="nav-item">
                <a href="{{ url("/system/vendortype") }}">
                    <i class="nav-icon i-Full-View-Window"></i>
                    <span class="item-name">Vendor Type</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("/system/productfields") }}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Product Fields</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("/system/vendorcategories") }}">
                    <i class="nav-icon i-Optimization"></i>
        ...
        <ul class="childNav" data-parent="featured_vendor_plans">
            <li class="nav-item">
                <a href="{{ url("featured_vendor_plans") }}">
                    <i class="nav-icon i-Full-View-Window"></i>
                    <span class="item-name">View Plans</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("featured_vendor_plans/create") }}">
                    <i class="nav-icon i-Add"></i>
                    <span class="item-name">Add Plan</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url("featured_vendor_plans/upgraderequests") }}">
                    <i class="nav-icon i-Optimization"></i>
                    <span class="item-name">Upgrade Requests</span>
                </a>
            </li>
